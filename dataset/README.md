...
- `NOTE1`: The unzip script is error :vv... all file unzipped into same folder name -> they overwrite each other. Kinda lazy to fix this :vv... so I guess I just manually unzip file and locate it probaly :vv... Use this script in terminal: `unzip filename.zip`
- 
